...
- Name: tests/a11y-main-landmark.test.mjs >> Main Landmark Accessibility >> /dashboard/onboarding should have exactly one top-level main landmark
...
Call log:
  - navigating to "http://localhost:3000/dashboard/onboarding", waiting until "load"
