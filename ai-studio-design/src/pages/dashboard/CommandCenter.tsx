    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 font-serif italic">Welcome back, {user?.username}. Here's the state of the truck.</p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-50 flex justify-between items-center">
              ...
              <Link to="/dashboard/operations" className="text-xs text-diner-teal font-bold hover:underline">VIEW CALENDAR</Link>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-50 flex justify-between items-center">
              ...
              <Link to="/dashboard/operations" className="text-xs text-diner-teal font-bold hover:underline">VIEW ALL</Link>
            </div>
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl group cursor-pointer hover:bg-diner-cream transition-colors">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-1">Due: {task.due} • {task.priority} Priority</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="p-6 space-y-6">
              {announcements.map((ann) => (
                <div key={ann.id} className="space-y-2">
                  ...
                  <p className="text-sm text-gray-300 font-serif leading-relaxed italic">"{ann.text}"</p>
                </div>
              ))}
            </div>
          </div>
