  ...
  return (
    <main className="bg-diner-cream">
      <section className="border-b-4 border-diner-black bg-diner-teal py-12 text-center text-diner-black md:py-20">
        ...
        <div className="mx-auto mt-6 flex max-w-2xl flex-col items-center justify-center gap-3 px-4 sm:flex-row sm:gap-4">
          <Link href="mailto:contact@jukesdiner.com?subject=Juke%27s%20Job%20Application" className="retro-button flex min-h-11 w-full max-w-xs items-center justify-center bg-diner-red text-white sm:w-auto">Apply by email</Link>
          <Link href="mailto:contact@jukesdiner.com?subject=Juke%27s%20Franchise%20Inquiry" className="retro-button flex min-h-11 w-full max-w-xs items-center justify-center bg-diner-black text-white sm:w-auto">Ask about franchise</Link>
        </div>
