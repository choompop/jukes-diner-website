...
import { Truck, Camera, MessageCircle, Globe } from 'lucide-react';
    ...
    <footer className="bg-diner-black text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-diner-red transition-colors"><Camera /></a>
              <a href="#" className="hover:text-diner-red transition-colors"><MessageCircle /></a>
              <a href="#" className="hover:text-diner-red transition-colors"><Globe /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link href="/find-us" className="hover:text-white transition-colors">Find Us</Link></li>
              <li><Link href="/book" className="hover:text-white transition-colors">Book Events</Link></li>
              <li><Link href="/apply" className="hover:text-white transition-colors">Franchise</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>&copy; 2026 Juke&apos;s Diner Franchise. All rights reserved.</p>
