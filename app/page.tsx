...
import { MENU_ITEMS, TESTIMONIALS } from '@/lib/constants';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <Link href="/about" className="text-diner-teal font-display flex items-center gap-2 hover:gap-4 transition-all">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Link href="/menu" className="text-diner-teal text-xs font-bold uppercase tracking-widest hover:underline">
                      Order Now
                    </Link>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              ...
              <p className="text-white/80 font-serif italic text-lg">
                &ldquo;Real food, real people, real fast. Juke&apos;s is the highlight of my lunch break every single Tuesday.&rdquo;
              </p>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
              {TESTIMONIALS.map((t) => (
                <div key={t.id} className="bg-white/10 p-8 rounded-3xl border border-white/20">
                  <p className="text-lg mb-6 font-serif italic">&ldquo;{t.text}&rdquo;</p>
